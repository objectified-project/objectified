...
export async function GET(
  ...
  try {
    ...
    const url = `${REST_API_BASE_URL}/repositories/${encodeURIComponent(auth.tenantSlug)}/${encodeURIComponent(params.id)}/specs/${encodeURIComponent(params.fileId)}/content${passthrough}`;
