      ...
      <div className={`flex-1 bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 overflow-hidden relative ${canvasPresentationActive ? 'pt-0' : ''}`}>
        {!selectedProjectId || !selectedVersionId ? (
          ...
          <>
            ...
            {/* Canvas tools: top-left trigger opens a left drawer (Expand, Collapse, Search, View Mode, Tags) */}
            {!canvasPresentationActive && (
              <>
                <Panel
                  position="top-left"
                ...
                >
                  <button
                    type="button"
                    onClick={() => setCanvasToolsDrawerOpen(true)}
                    aria-expanded={canvasToolsDrawerOpen}
                    aria-haspopup="dialog"
                    aria-controls="ade-canvas-tools-drawer"
                    title="Canvas tools — expand, collapse, search, view mode"
                    className={`p-2 rounded-lg transition-all duration-200 flex items-center gap-2 text-xs font-medium border ${
                ...
                <Dialog.Root open={canvasToolsDrawerOpen} onOpenChange={setCanvasToolsDrawerOpen}>
                  <Dialog.Portal>
                    <Dialog.Overlay className="fixed inset-0 z-[10050] bg-black/40 dark:bg-black/50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
                    <Dialog.Content
                      id="ade-canvas-tools-drawer"
                      className="fixed inset-y-0 left-0 z-[10051] flex h-full w-full max-w-sm flex-col border-r border-gray-200/80 dark:border-gray-700/80 bg-white shadow-2xl outline-none dark:bg-gray-800 transition-transform duration-200 ease-out data-[state=closed]:-translate-x-full data-[state=open]:translate-x-0"
                    >
                      <Dialog.Title className="sr-only">Canvas tools</Dialog.Title>
                      <div className="flex shrink-0 items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-700">
                        <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">Canvas tools</span>
                        <Dialog.Close
                          type="button"
                      ...
                      <div className="flex flex-1 flex-col gap-3 overflow-y-auto p-4">
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            ...
                            className="px-3 py-2 text-xs font-medium rounded-lg transition-all duration-200 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center justify-center gap-1.5 border border-transparent hover:border-indigo-200 dark:hover:border-indigo-700"
                        ...
                        <button
                          ...
                          className="w-full px-3 py-2 text-xs font-medium rounded-lg transition-all duration-200 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center justify-center gap-1.5 border border-transparent hover:border-indigo-200 dark:hover:border-indigo-700"
                        ...
                        <DropdownMenu.Root>
                          <DropdownMenu.Trigger asChild>
                            <button
                              type="button"
                              className={`w-full px-3 py-2 text-xs font-medium rounded-lg transition-all duration-200 flex items-center gap-1.5 border justify-between ${
                                canvasVisibilityRestricted
                                  ? 'bg-indigo-100 dark:bg-indigo-900/40 text-indigo-700 dark:text-indigo-300 border-indigo-200 dark:border-indigo-700'
                            ...
                            >
                              <span className="flex items-center gap-1.5 min-w-0">
                                ...
                                <span className="truncate">View Mode</span>
                              </span>
                          ...
                          <DropdownMenu.Portal>
                            <DropdownMenu.Content
                              className="min-w-[200px] bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-1 z-[10060] overflow-visible"
                              sideOffset={5}
                              align="start"
                            >
                              ...
                              <DropdownMenu.Sub>
                                ...
                                <DropdownMenu.SubContent
                                  className="min-w-[180px] max-w-[240px] rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 py-1 z-[10060] overflow-x-hidden"
                                  sideOffset={4}
                                  alignOffset={-4}
                                >
                                  {groups.length === 0 ? (
                              ...
                              <DropdownMenu.Sub>
                                ...
                                <DropdownMenu.SubContent
                                  className="min-w-[200px] max-w-[260px] rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 py-1 z-[10060] overflow-x-hidden"
                                  sideOffset={4}
                                  alignOffset={-4}
                                >
                                  {groups.length === 0 ? (
                        ...
                        {!isReadOnly && (
                          <button
                            ...
                            className="w-full px-3 py-2 text-xs font-medium rounded-lg transition-all duration-200 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-amber-50 dark:hover:bg-amber-900/30 hover:text-amber-600 dark:hover:text-amber-400 flex items-center justify-center gap-1.5 border border-transparent hover:border-amber-200 dark:hover:border-amber-700"
                            title="Manage project tags"
                          >
