...
prompt REST_RELOAD "Enable auto-reload (True/False)" "True"
...
prompt NEXT_PUBLIC_BETA_MODE "Enable beta mode indicator (true/false)" "true"
...
printf '\n'
ok "Setup complete: ${CREATED} file(s) written, ${SKIPPED} skipped."
printf '\n'
info "Next steps:"
